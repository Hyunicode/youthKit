...
const props = withDefaults(defineProps<YkCheckoutboxProps>(), {
  options: () => [],
  disabled: false,
  vertical: false,
  value: () => [],
...
<template>
  <div class="yk-checkbox" :style="`max-width: ${maxWidth}; max-height: ${maxHeight};`">
    <template v-if="sum">
      <div
      ...
      >
        ...
        >
          <span
            class="u-checkbox"
            :class="{ 'u-checkbox-checked': checkedValue.includes(option.value) }"
          ></span>
          <span class="u-label">
    ...
    <div v-else class="yk-checkbox-wrap">
      <div class="yk-box" :class="{ disabled: disabled }" @click="onCheckAll">
        <span
          class="u-checkbox"
